 ...
 * specifying the {@code "com.wuyiccc.hellonetty.debug"} system property (e.g.
 * {@code java -Dcom.wuyiccc.hellonetty.debug ...})
 *
...
public class DebugUtil {
    ...
    public static boolean isDebugEnabled() {
        String value;
        try {
            value = SystemPropertyUtil.get("com.wuyiccc.hellonetty.debug");
        } catch (Exception e) {
            value = null;
        }
